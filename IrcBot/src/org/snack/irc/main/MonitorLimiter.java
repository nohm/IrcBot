 ...
 */
public class MonitorLimiter implements DocumentListener {
	 ...
	 */
	public MonitorLimiter(int maximumLines) {
	 ...
	 */
	public MonitorLimiter(int maximumLines, boolean isRemoveFromStart) {
